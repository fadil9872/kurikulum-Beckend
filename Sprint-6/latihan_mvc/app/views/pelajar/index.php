    ...
    <div class="row">
        <div class="col-6">
            <h3>Daftar Pelajar</h3>   
                <ul class="list-group">
                    <?php foreach ($data['pelajar'] as $pelajar):?>
                        <li class="list-group-item">
                            <?=$pelajar['nama']?>
                            <a href="<?=BASEURL;?>/Pelajar/hapus/<?=$pelajar['id'];?>
                            " class="badge badge-danger float-right ml-1" onclick="return confirm('apakah anda yakin ingin menghapus?') ;">hapus</a>
                            <a href="<?=BASEURL;?>/Pelajar/ubah/<?=$pelajar['id'];?>
                            " class="badge badge-success float-right ml-1 tampilModalUbah" data-toggle="modal" data-target="#formModal" data-id="<?= $pelajar['id'] ?>">ubah</a>
                            <a href="<?=BASEURL;?>/Pelajar/detail/<?=$pelajar['id'];?>
      ...
      <div class="modal-body">
        ...
        <form action="<?= BASEURL; ?>/Pelajar/tambah" method="post">
            ...
            <div class="form-group">
                ...
                <option value="Fronend">Fronend</option>
